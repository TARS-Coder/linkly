<x-app-layout>
    <x-slot name="header">
        <p class="text-[#101518] tracking-light text-[32px] font-bold leading-tight min-w-72">{{ __('Add New Company') }}</p>
    </x-slot>
          ...
          <div class="layout-content-container flex flex-col py-2 flex-1 w-full">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-1">
                ...
                <p class="text-[#6a7681] text-sm font-normal leading-normal">Add new company's information</p>
              </div>
            </div>
            <div class="flex max-w-[600px] flex-wrap items-end gap-4 px-4">
              <label class="flex flex-col min-w-40 flex-1">
                ...
                <input type="text" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121416] focus:outline-0 focus:ring-0 border border-[#dde1e3] bg-white focus:border-[#dde1e3] h-14 placeholder:text-[#6a7681] p-[15px] text-base font-normal leading-normal"
                  name="name" placeholder="Add company name" required
                />
              </label>
            </div>
            <div class="flex max-w-[600px] flex-wrap items-end gap-4 px-4">
              <label class="flex flex-col min-w-40 flex-1">
                ...
                <input type="email" oninput="this.value = this.value.toLowerCase()" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121416] focus:outline-0 focus:ring-0 border border-[#dde1e3] bg-white focus:border-[#dde1e3] h-14 placeholder:text-[#6a7681] p-[15px] text-base font-normal leading-normal"
                  name="email" placeholder="Add company email address" required
                />
              </label>
            </div>
            <div class="flex max-w-[600px] flex-wrap items-end gap-4 px-4">
              <label class="flex flex-col min-w-40 flex-1">
                ...
                <textarea
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121416] focus:outline-0 focus:ring-0 border border-[#dde1e3] bg-white focus:border-[#dde1e3] min-h-28 placeholder:text-[#6a7681] p-[5px] text-base font-normal leading-normal"
                  name="desc" placeholder="Add company description"
                  >
                </textarea>
              </label>
            </div>
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-1">
                <p class="text-[#121416] tracking-light text-[28px] font-bold leading-tight">Invite Admin in Company</p>
              </div>
            </div>
            <div class="flex max-w-[600px] flex-wrap items-end gap-4 px-4">
              <label class="flex flex-col min-w-40 flex-1">
                ...
                <input type="text" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121416] focus:outline-0 focus:ring-0 border border-[#dde1e3] bg-white focus:border-[#dde1e3] h-14 placeholder:text-[#6a7681] p-[15px] text-base font-normal leading-normal"
                  name="admin_name" placeholder="Add admin email address to invite"
                />
              </label>
            </div>
            <div class="flex max-w-[600px] flex-wrap items-end gap-4 px-4">
              <label class="flex flex-col min-w-40 flex-1">
                ...
                <input type="email" oninput="this.value = this.value.toLowerCase()" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121416] focus:outline-0 focus:ring-0 border border-[#dde1e3] bg-white focus:border-[#dde1e3] h-14 placeholder:text-[#6a7681] p-[15px] text-base font-normal leading-normal"
                  name="admin_email" placeholder="Add admin email address to invite"
                />
              </label>
            </div>
